...
(async () => {
  ...
  await page.waitForTimeout(600);
  await page.click('#modalSolicitarAssinatura button:has-text("Sim")');

  // aguarda o modal de sucesso aparecer (processo real na D4Sign, pode levar ate 20-30s)
  await page.waitForSelector('#modalAssinaturaEnviada.show', { timeout: 60000 });
  await page.waitForTimeout(500);
  await shot(page, '02b-modal-enviado-com-sucesso');
