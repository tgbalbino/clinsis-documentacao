...
(async () => {
  ...
  await shot(page, '07-contrato-aguardando-assinatura-bloqueado');

  // ---- Cancelar solicitacao de assinatura ----
  await page.click('.modal.show button.btn-danger:has([class*="fa-ban"])');
  await page.waitForTimeout(600);
  await shot(page, '08-confirmar-cancelar-assinatura');
  await page.click('#modalCancelarAssinatura button:has-text("Sim")');
  await page.waitForTimeout(4000);
  await shot(page, '09-apos-cancelar-assinatura');
