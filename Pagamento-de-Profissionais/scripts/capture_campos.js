...
(async () => {
  ...
  // Aba Especialidades: mostra a tabela com Tipo de Marcacao, Valor, Valor Convenio
  await page.click('button[data-bs-target="#especialidade"]');
  await page.waitForTimeout(500);
  await shot(page, '13-vigencia-aba-especialidades');

  // Aba Profissionais: abre o modal "$" do primeiro profissional pra mostrar o override
  await page.click('button[data-bs-target="#profissionais"]');
  await page.waitForTimeout(500);
  await page.click('#profissionais table tbody tr:has-text("Profissional 01") button.btn-primary');
  await page.waitForSelector('.modal.show', { timeout: 5000 });
  await page.waitForTimeout(500);
  await shot(page, '14-vigencia-modal-valores-profissional');
