...
(async () => {
  ...
  await shot(page, '15-especialidade-lista-tipocobranca');

  await page.click('table tbody tr:has-text("FISIOTERAPEUTA") button.btn-warning');
  await page.waitForSelector('.modal.show', { timeout: 5000 });
  await page.waitForTimeout(500);
  await shot(page, '16-especialidade-cadastro-tipocobranca');
