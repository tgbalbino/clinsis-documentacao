...
![Tela inicial de Contas Recorrentes.](00-lista-inicial.png)

_Tela inicial de Contas Recorrentes._
...
![Cadastro de exemplo: aluguel mensal de R$ 1.500,00, vencendo dia 10.](01-novo-modal-preenchido.png)

_Cadastro de exemplo: aluguel mensal de R$ 1.500,00, vencendo dia 10._
...
![Depois de salvar, a nova recorrência aparece na lista.](02-apos-salvar.png)

_Depois de salvar, a nova recorrência aparece na lista._
...
![Depois de forçar a execução: uma nova linha aparece no histórico (Status "OK", "Qtd. Gerada" = quantas contas foram criadas nessa rodada) e um aviso confirma quantas contas foram geradas.](04-log-job-executado.png)

_Depois de forçar a execução: uma nova linha aparece no histórico (Status "OK", "Qtd. Gerada" = quantas contas foram criadas nessa rodada) e um aviso confirma quantas contas foram geradas._
...
![Tela de Contas a Pagar mostrando a conta "ALUGUEL DA SALA 2" gerada automaticamente pelo job, já com vencimento no dia 10 configurado.](05-conta-pagar-gerada.png)

_Tela de Contas a Pagar mostrando a conta "ALUGUEL DA SALA 2" gerada automaticamente pelo job, já com vencimento no dia 10 configurado._
