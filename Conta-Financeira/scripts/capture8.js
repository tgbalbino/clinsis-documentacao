...
(async () => {
  ...
  await shot(page, '20-movimentos');
  const html = await page.content();
  require('fs').writeFileSync('movimentos.html', html);

  await page.goto(`${APP}/financeiro/fluxocaixa`);
  await page.waitForLoadState('networkidle');
  await esconderMenuTestes();
  await page.waitForTimeout(1500);
  await shot(page, '21-fluxo-caixa');
  require('fs').writeFileSync('fluxo.html', await page.content());
