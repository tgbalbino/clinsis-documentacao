...
ITENS = [
    ...
    (7, "video-tabela-preco-cobranca", "Tabela-de-Precos-Cobranca", "Tabela de Preços: Cobrança", "CADASTROS"),
    (8, "video-tabela-preco-pagamento", "Tabela-de-Precos-Pagamento", "Tabela de Preços: Pagamento", "CADASTROS"),
